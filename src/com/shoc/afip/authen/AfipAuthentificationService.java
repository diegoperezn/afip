...
public class AfipAuthentificationService {
    ...
    public static AfipAuthentification autentificarAfip() throws FileNotFoundException {
        ...
        String dstDN = config.getProperty("dstdn", "SERIALNUMBER=CUIT 20326416763, CN=test");

        String p12file = config.getProperty("keystore", "certificado.p12");
        ...
        return new AfipAuthentification(token, sign);
    }
